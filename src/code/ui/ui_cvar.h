...
#ifdef MISSIONPACK2
UI_CVAR( ui_redteam5, "ui_redteam6", "0", CVAR_ARCHIVE )
UI_CVAR( ui_redteam5, "ui_redteam7", "0", CVAR_ARCHIVE )
UI_CVAR( ui_blueteam1, "ui_blueteam6", "0", CVAR_ARCHIVE )
UI_CVAR( ui_blueteam1, "ui_blueteam7", "0", CVAR_ARCHIVE )
#endif
