chat "callisto"
{
	...
	{	
		...
		"Callisto is in da house, baby. Woohoo!";
		HELLO5;
		// 0 = bot name
	} //end type
	...
	{	
		...
		"Back to your cells or Callisto spanks!";
		LEVEL_START0;
		// 0 = bot name
	...
	{	
		"Hey, ", 3, ", good game.";
		"Poor thing! Come here and let Callisto give you a hug ", 3, ".";
		"We are victorious!";
		LEVEL_END_VICTORY1;
		// 0 = bot name
	...
	{	
		...
		"That was too gross of a way to die even for me...";
	...
	{	
		"Drat. I hope this happens to you next, ", 0, "!";
		DEATH_SLIME0;
		// 0 = enemy name
	} //end type
